...
class Kiwoom(QAxWidget):
    ...
    def detail_account_mystock(self, sPrevNext='0'):
        ...
        self.dynamicCall('SetInputValue(String, QString)', '계좌번호', self.account_num)
        self.dynamicCall('SetInputValue(String, QString)', '비밀번호', '0000')
        self.dynamicCall('SetInputValue(String, QString)', '비밀번호입력매체구분 ', '00')
        self.dynamicCall('SetInputValue(String, QString)', '조회구분', '2')
    ...
    def trdata_slot(self, sScrNo, sRQName,  sTrCode, sRecordName, sPrevNext):
        ...
        if sRQName == '예수금상세현황요청':
            ...
            self.detail.account_account_info_event_loop.exit()
        ...
        if sRQName == '계좌평가잔고내역요청':
            ...
            for i in range(rows):
                ...
                code_nm = self.dynamicCall("GetCommData(QString, int, QString)", sTrCode, sRQName, i, '종목명')
                stock_quantity = self.dynamicCall('GetCommData(QString, QString, int, QString)', sTrCode, sRQName, i, '보유수량')
                buy_price = self.dynamicCall('GetCommData(QString, QString, int, QString)', sTrCode, sRQName, i, '매입가')
                learn_rate = self.dynamicCall('GetCommData(QString, QString, int, QString)', sTrCode, sRQName, i, '수익률(%)')
                current_price = self.dynamicCall('GetCommData(QString, QString, int, QString)', sTrCode, i, cnt, '현재가')
