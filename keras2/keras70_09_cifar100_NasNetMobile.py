...
from tensorflow.keras.applications import VGG16, VGG19, ResNet101, DenseNet121, MobileNet, NASNetMobile
...
# vgg16.summary()
nasnetmobile.trainable = True    # 가중치를 동결시킨다
# print(vgg16.weights)
...
#   File "d:\Study\keras2\keras69_09_cifar100_NasNetMobile.py", line 57, in <module>
#     nasnetmobile = NASNetMobile(weights='imagenet', include_top=False, input_shape=(32,32,3))
#   File "C:\ProgramData\Anaconda3\envs\tf270gpu\lib\site-packages\keras\applications\nasnet.py", line 386, in NASNetMobile
#     return NASNet(
#   File "C:\ProgramData\Anaconda3\envs\tf270gpu\lib\site-packages\keras\applications\nasnet.py", line 174, in NASNet
#     input_shape = imagenet_utils.obtain_input_shape(
#   File "C:\ProgramData\Anaconda3\envs\tf270gpu\lib\site-packages\keras\applications\imagenet_utils.py", line 349, in obtain_input_shape
