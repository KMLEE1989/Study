...
#2. 모델구성
eb0 = EfficientNetB0(weights='imagenet', include_top=False, input_shape=(32,32,3))

# vgg16.summary()
eb0.trainable = False    # 가중치를 동결시킨다
# print(vgg16.weights)
...
######################################## 1. EfficientNetB0 trainable : True, Flatten ###############################################
# learning_rate :  0.0001
# loss :  4.6073
# accuracy :  0.0086
# 걸린시간 : 126.8671
######################################## 2. EfficientNetB0 trainable : False, Flatten ###############################################
# learning_rate :  0.0001
# loss :  4.6055
# accuracy :  0.0097
# 걸린시간 : 86.0994
######################################## 3. EfficientNetB0 trainable : True, GAP ###############################################
# learning_rate :  0.0001
# loss :  3.2368
# accuracy :  0.4539
# 걸린시간 : 300.6791
######################################## 4. EfficientNetB0 trainable : False, GAP ###############################################
# learning_rate :  0.0001
# loss :  4.6055
# accuracy :  0.0104
# 걸린시간 : 61.5434