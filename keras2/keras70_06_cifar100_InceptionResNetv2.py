...
from tensorflow.keras.applications import VGG16, VGG19, ResNet101, InceptionResNetV2
...
# vgg16.summary()
inceptionresnetv2.trainable = True    # 가중치를 동결시킨다
# print(vgg16.weights)
...
#   File "d:\Study\keras2\keras69_06_cifar100_InceptionResNetv2.py", line 57, in <module>
#     inceptionresnetv2 = InceptionResNetV2(weights='imagenet', include_top=False, input_shape=(32,32,3))
#   File "C:\ProgramData\Anaconda3\envs\tf270gpu\lib\site-packages\keras\applications\inception_resnet_v2.py", line 130, in InceptionResNetV2
