...
start = time.time()
model.fit(x_train, y_train, epochs=100, batch_size=100, verbose=1, validation_split=0.2, callbacks=[es, reduce_lr]) 
end = time.time() - start
...
#   File "c:\KM CD\1.py", line 57, in <module>
#     xception = Xception(weights='imagenet', include_top=False, input_shape=(32,32,3))
#   File "C:\ProgramData\Anaconda3\envs\sub\lib\site-packages\keras\applications\xception.py", line 127, in Xception
#     input_shape = imagenet_utils.obtain_input_shape(
#   File "C:\ProgramData\Anaconda3\envs\sub\lib\site-packages\keras\applications\imagenet_utils.py", line 376, in obtain_input_shape
