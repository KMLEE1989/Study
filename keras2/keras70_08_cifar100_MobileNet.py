...
from tensorflow.keras.applications import VGG16, VGG19, ResNet101, DenseNet121, MobileNet
...
# vgg16.summary()
mobilenet.trainable = False    # 가중치를 동결시킨다
# print(vgg16.weights)
...
######################################## 1. MobileNet trainable : True, Flatten ###############################################
# learning_rate :  0.0001
# loss :  3.0443
# accuracy :  0.3419
# 걸린시간 : 84.3249
######################################## 2. MobileNet trainable : False, Flatten ###############################################
# learning_rate :  0.0001
# loss :  4.4665
# accuracy :  0.0255
# 걸린시간 : 46.3342
######################################## 3. MobileNet trainable : True, GAP ###############################################
# learning_rate :  0.0001
# loss :  3.0985
# accuracy :  0.3237
# 걸린시간 : 84.5949
######################################## 4. MobileNet trainable : False, GAP ###############################################
# learning_rate :  0.0001
# loss :  4.484
# accuracy :  0.017
# 걸린시간 : 44.675
