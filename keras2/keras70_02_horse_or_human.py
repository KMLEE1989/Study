...
#print(randidx) # [614 481 904 ... 592  50   5]
#print(np.min(randidx), np.max(randidx)) # 1 1026

x_augmented = x_train[randidx].copy()  #copy() 메모리 생성
y_augmented = y_train[randidx].copy()  
#print(x_augmented.shape) # (1500, 100, 100, 3)
#print(y_augmented.shape) # (1500,)
...
print(x_train.shape, y_train.shape)  #(2527, 100, 100, 3) (2527,)
print(np.unique(y_train)) # [0. 1.]

eb0 = EfficientNetB0(weights='imagenet', include_top=False, input_shape=(100,100,3))
