...
w2 = tf.compat.v1.Variable(tf.random.normal([30,40], name='weight2'))
b2 = tf.compat.v1.Variable(tf.random.normal([40]), name='bias2')

Hidden_layer2 = tf.sigmoid(tf.matmul(Hidden_layer1 , w2)+b2)
# hypothesis = tf.sigmoid(tf.matmul(Hidden_layer1 , w2)+b2)
# #시작

w3 = tf.compat.v1.Variable(tf.random.normal([40,50], name='weight3'))
b3 = tf.compat.v1.Variable(tf.random.normal([50]), name='bias3')

Hidden_layer3 = tf.sigmoid(tf.matmul(Hidden_layer2 , w3)+b3)

w4 = tf.compat.v1.Variable(tf.random.normal([50,1], name='weight4'))
