...
x1,y1=split_xy2(x1,30,1)
x21,y1=split_xy2(x21,30,1)
x22,y1=split_xy2(x22,30,1)
x23,y1=split_xy2(x23,30,1)
x24,y1=split_xy2(x24,30,1)
x3,y1=split_xy2(x3,30,1)
...
# print(x1_train.shape, x1_test.shape) #(478, 30, 1) (205, 30, 1)
# print(x21_train.shape, x21_test.shape) #(478, 30, 16) (205, 30, 16)
# print(x22_train.shape, x22_test.shape) #(478, 30, 16) (205, 30, 16)
# print(x23_train.shape, x23_test.shape) #(478, 30, 16) (205, 30, 16)
# print(x24_train.shape, x24_test.shape) #(478, 30, 16) (205, 30, 16)
# print(x3_train.shape, x3_test.shape)  #(478, 30, 3) (205, 30, 3)
# print(y1_train.shape, y1_test.shape) #(478, 1) (205, 1)

#print(y1.shape)
y1=y1.reshape(683,1,1)
...
output2=Dense(32, activation='relu', name='output2')(dense14)

input3=Input(shape=(30,16))
...
output3=Dense(32, activation='relu', name='output3')(dense24)

input4=Input(shape=(30,16))
...
output4=Dense(32, activation='relu', name='output4')(dense34)

input5=Input(shape=(30,16))
...
output5=Dense(32, activation='relu', name='output5')(dense24)

input6=Input(shape=(30,3))
...
output6=Dense(32, activation='relu', name='output6')(dense24)
...
start=time.time()
model.fit([x1_train, x21_train, x22_train, x23_train, x24_train, x3_train], [y1_train], epochs=100, batch_size=32, validation_data=([x1,x21,x22,x23,x24,x3],[y1]), verbose=1)
end=time.time()-start
...
print("대한민국의 1월 일간 평균 기온: ", y1_predict[:30])
