...
x_test=np.load('./_save_npy/keras48_3_train_x.npy')
y_train=np.load('./_save_npy/keras48_3_train_y.npy')
y_test=np.load('./_save_npy/keras48_3_train_y.npy')
...
hist = model.fit(x_train, y_train, epochs = 10, #steps_per_epoch = 72,  
