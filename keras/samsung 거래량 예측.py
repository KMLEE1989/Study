...
x1=x1.drop(columns=['일자','시가','고가','저가','종가', "Unnamed: 6", '전일비' , '등락률'], axis=1)
x2=x2.drop(columns=['일자','시가','고가','저가','종가', "Unnamed: 6", '전일비' , '등락률'], axis=1)
# print(x1.describe) #거래량  금액(백만)   신용비     개인     기관  외인(수량)    외국계   프로그램    외인비
# print(x2.describe) #거래량  금액(백만)   신용비     개인     기관  외인(수량)    외국계   프로그램    외인비

x1=np.array(x1)
x2=np.array(x2)
#print(x1.shape, x2.shape)  #(893, 9) (893, 9)
...
#print(x1.shape,x2.shape,y1.shape,y2.shape) #(893, 9) (893, 9) (1120,) (1060,)
...
#print(x1.shape, y1.shape) (887, 5, 8) (887, 3)
#print(x2.shape, y2.shape)  (887, 5, 8) (887, 3)
...
model.save_weights("../study/_save/samsung stock price 가중치 제출.h5")
...
print('삼성예측거래량: ' , y1_pred[-1])
print('키움예측거래량: ' , y2_pred[-1])
