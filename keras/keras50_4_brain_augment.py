...
# <keras.preprocessing.image.DirectoryIterator object at 0x00000260A64ED0A0>
...
# <keras.preprocessing.image.DirectoryIterator object at 0x000001BE6D68EF10>
...
#print(randidx) # [  9  95  58 ... 100  85 105]
...
#print(x_train.shape, y_train.shape)  # (3160, 150, 150, 3) (3160,)
...
model.fit(x_train, y_train, epochs=1, batch_size=20, validation_split=0.2, callbacks=[es]) 
