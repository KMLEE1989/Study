...
#print(x1.shape, x2.shape, x3.shape, y1.shape) #(712, 2) (2848, 18) (712, 4) (712, 3)

x1=x1.reshape(712,2,1)
x2=x2.reshape(712,8,9)
x3=x3.reshape(712,4,1)
y1=y1.reshape(712,3,1)

#print(x1.shape, x2.shape, x3.shape, y1.shape) #(712, 2, 1) (712, 8, 9) (712, 4, 1) (712, 3, 1)
...
# print(x2_train.shape, x2_test.shape) (498, 8, 9) (214, 8, 9)
...
model.fit([x1_train, x2_train, x3_train], [y1_train], epochs=10, batch_size=8, validation_data=([x1,x2,x3],[y1]), verbose=1)
'''
results=model.evaluate([x1_test,x2_test,x3_test],[y1_test])
...
loss=model.evaluate([x1_test,x2_test,x3_test], [y1_test], batch_size=8)
print('loss:',loss)
