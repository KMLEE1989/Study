...
#print(train_generator) <keras.preprocessing.image.DirectoryIterator object at 0x000002CA8FF3B7F0>
...
#print(validation_generator) <keras.preprocessing.image.DirectoryIterator object at 0x000002709462B3D0>
#Found 992 images belonging to 2 classes.


print(train_generator[0][0].shape, train_generator[0][1].shape)  # (10, 150, 150, 3) (10, 2)
print(validation_generator[0][0].shape, validation_generator[0][1].shape) # (10, 150, 150, 3) (10, 2)
...
# print(train_generator[0][0].shape, validation_generator[0][1].shape)(10, 150, 150, 3) (10, 2)
...
hist = model.fit_generator(train_generator, epochs = 10, steps_per_epoch = 200,  
...
model_path = 'D:\\Study\\_ModelCheckPoint\\k26_1229_0939_0010-0.6655.hdf5'
...
# loss: 0.6737145185470581
# val_loss: 0.671518862247467
# accuracy: 0.5763645172119141
