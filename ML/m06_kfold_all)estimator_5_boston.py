...
allAlgorithm = all_estimators(type_filter = 'regressor')  # regressor에 대한 모든 측정기
...
for (name, algorithm) in allAlgorithm:   # [('AdaBoostClassifier', <class 'sklearn.ensemble._weight_boosting.AdaBoostClassifier'>),...
    try:
        model = algorithm()
