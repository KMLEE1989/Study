...
submission = pd.read_csv('D:/_data/dacon/image/data/sample_submission.csv')


train_imgs = glob('D:/_data/dacon/image/data/train/*/*')
train_labels = [path.split('\\')[1] for path in train_imgs]
test_imgs = glob('D:/_data/dacon/image/data/test/*')
...
train_imgs, val_imgs, train_labels, val_labels = train_test_split(train_imgs, train_labels, test_size = 0.3, 
