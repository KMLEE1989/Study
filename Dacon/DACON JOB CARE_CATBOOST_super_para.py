...
for tri, vai in cv.split(x_train):
    ...
    model = CatBoostClassifier(iterations=iterations, random_state=SEED, max_depth=4,
                               task_type="GPU",eval_metric="F1", cat_features=cat_features, one_hot_max_size=4)
...
submit_file.to_csv(path + 'sookook444.csv',index=False)
