...
path1 = "D:/Study/Hackarthon/dacon/Anomaly_Detection/open/open/"
path2 = 'D:/Study/Hackarthon/dacon/Anomaly_Detection/open/open/train/train/'
path3 = 'D:/Study/Hackarthon/dacon/Anomaly_Detection/open/open/test/test/'

device = torch.device('cuda')

train_png = sorted(glob(path2 + '*.png'))
test_png = sorted(glob(path3 + '*.png'))

train_y = pd.read_csv(path1 + "train_df.csv")
...
class Network(nn.Module):
    def __init__(self):
        ...
        self.model = timm.create_model('resnet101', pretrained=True, num_classes=88)
...
submission.to_csv(path1 + "sookook55.csv", index = False)
