...
model.fit(x_train, y_train, epochs=45, batch_size=10, validation_split=0.5, verbose=1)
...
#R2   #역피라미드 epochs=30 
#70
#append valdiation: loss: 2082.2373046875 val_loss: 3176.4116 r2스코어: 0.6092125778023232